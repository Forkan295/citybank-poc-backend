        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-xl font-semibold text-gray-900">Activiry Log Details</h1>
                </div>
                             ...
                             <table class="min-w-full bg-white">
                                @foreach ($activityLog->properties as $key => $item)
                                    <tr class="border-t border-gray-300">
                                        ...
                                        <th>&nbsp;&nbsp;:&nbsp;&nbsp;</th>
                                        <td scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">{{ ($key == 'status' && $item == 1) ? 'success' : $item }}</td>
                                    </tr>
                                @endforeach
                            </table>
                            </div>
