                                ...
                                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                                    ...
                                    {{-- <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="file" name="photo" id="photo" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                            @if ($errors->has('photo'))
                                            <span class="text-sm text-red-600">{{ $errors->first('photo') }}</span>
                                          @endif
                                        </div>
                                    </div> --}}
                                </div>
